export default function About() {
  return (
    <div className="page">
      <div>
        <div className="section-title">
          ...
          <p>
            Small Steps, Big Skills is a Girl Scouts Gold Award project focused on teaching practical sewing and repair skills through workshops and video tutorials. 
            The Girl Scout Gold Award is the highest achievement in Girl Scouts, recognizing projects that create sustainable, long-term impact in the community.
          </p>
        </div>
      ...
      <p
        ...
        to Sew Initiative</strong>, a Girl Scouts Gold Award project focused on
        helping Gen Z and future generations build essential life skills.
        Recognizing that practical skills like sewing and clothing repair are often
        overlooked, Allison created this initiative to make hands-on learning
        accessible, welcoming, and engaging.
        <br /><br />
        Allison has been a Girl Scout since kindergarten. She began scouting in
        Pinehurst, North Carolina, and after moving to Virginia continued with Troop
        606, where she remains active today. Over the years, she has earned the
        Bronze Award, Silver Award, and the Silver Trefoil.
        <br /><br />
        Sewing and creativity have always been part of Allison’s life. With both her
        mother and grandmother working as Family and Consumer Science (FCS) teachers,
        she grew up surrounded by sewing, crafting, baking, and other practical
        skills—experiences that helped inspire this project.
        <br /><br />
        Through community workshops and instructional video tutorials, Allison
        teaches foundational sewing skills that empower participants to care for
        their clothing, reduce waste, and gain confidence in creating and repairing
        items on their own. Her work brings together education, sustainability, and
        community involvement to ensure these valuable skills are passed on and
        preserved.
      </p>
    </div>
    ...
    <div className="card" style={{ marginTop: 20, padding: 32, display: "flex", flexDirection: "column", alignItems: "center", }}>
      ...
      <p
        style={{ maxWidth: 700,textAlign: "left", lineHeight: 1.7, color: "#374151",fontSize: 16,}}>
          Girl Scout troop leader — and Allison’s mom — who helps with organization, planning, and ongoing project support.
      </p>
    </div>
